...
int main(void)
{
    ...
    camera.target = (Vector3){ 2.0f, 2.5f, 5.0f };
        ...
        BeginDrawing();
            ...
            BeginMode3D(camera);
                ...
                //    (Vector3){ 2.0f, 1.0f, 0.0f }, 2.0f, 2.0f, 2.0f, WHITE);
                 ...
                 float textureWidth = (float)texture.width;    // Get texture width
                 float textureHeight = (float)texture.height;  // Get texture height
                 
                 // Wall dimensions
                 float wallWidth = 3.0f;   // Width of the wall
                 ...
                 DrawCubeTextureRec(texture, 
                     (Rectangle){ 0.0f, 0.0f, textureCoordX, textureCoordY }, // Adjusted texture coordinates
                     (Vector3){ 2.0f, 2.5f, 0.0f }, // Wall positioned correctly
                     wallWidth, wallHeight, 2.0f, WHITE); // 5x5 wall with texture
